const CONFIG = {
    mainQuestion: "will you be my Fineshyt?",
    subQuestion: "please say yes ",
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["eits, no noo😝", "hehe, repeat 😜", "okay, i hope YES yeah! 💕"],
    confirmTitle: "YEAAAY! do you really want to 💗",
    confirmText: "from now on you are officially a…",
    badgeText: "MY FINESHYTTT",
    nextButton: "NEXT ",
    repeatButton: "repeat the question",
    flowerTitle: "this is a special gift for you ",
    takeBouquetButton: "receive the gift ",
    bouquetMessage: "yeay! it's already yours 💕",
    nextFlowerButton: "Next ",
    collageTitle: "my beautiful YOUU!!!",
    collageSubtitle: "since you came along, even simple things feel special, my favorite person. 💕",
    nextCollageButton: "one more page… ",
    finalTitle: "CONGRATSSS, My Love 💞",
    finalMessage: `thank you for being there and making my days feel full. you're the reason why a smile comes so easily. may your days always be filled with warmth and happiness. i'm always here for you. 💕`,
    restartButton: "Restart ",
    copyButton: "Copy Message ",
    copySuccess: "message successfull copy! "
};
